...
public class EventsController extends BaseController {    
    ...
    public void getEventIndividualAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5612108667831609892L;
            {
                    put( "eventId", eventId );
            }});
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5471554651030148665L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4877743703672915702L;
            {
    ...
    public void getEventCharacterCollectionAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5150858704054601641L;
            {
                    put( "eventId", eventId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4701168169828708615L;
            {
                    put( "comics", comics );
                    put( "limit", limit );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5190013102157181189L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.getReferer() );
    ...
    public void getComicsCollectionByEventIdAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4731910987869079055L;
            {
                    put( "eventId", eventId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4797293202210448736L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5560307954289155050L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.getReferer() );
    ...
    public void getCreatorCollectionByEventIdAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5627568666699102241L;
            {
                    put( "eventId", eventId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4639624217758072158L;
            {
                    put( "comics", comics );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5126776570769856703L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.getReferer() );
    ...
    public void getEventSeriesCollectionAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5229675774931299004L;
            {
                    put( "eventId", eventId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4900515360593475593L;
            {
                    put( "characters", characters );
                    put( "comics", comics );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5636964706004430576L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.getReferer() );
    ...
    public void getEventStoryCollectionAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5380032925605095126L;
            {
                    put( "eventId", eventId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5526287290659639166L;
            {
                    put( "characters", characters );
                    put( "comics", comics );
                    put( "creators", creators );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5685959286155347671L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.getReferer() );
    ...
    public void getEventsCollectionAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5647861953341523435L;
            {
                    put( "characters", characters );
                    put( "comics", comics );
                    put( "creators", creators );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5597358167195573827L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.getReferer() );
